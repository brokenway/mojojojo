...
var HEIGHT = 600;
var canvasHelper;
var colors = new Array('red', 'blue', 'green', 'orange', 'black');
var shapes = new Array('rays', 'square', 'circle', 'triangle', 'burst', 'star', 'line');
...
CanvasHelper.prototype.drawSquare = function() {
  ...
  this.context.beginPath();
  this.context.strokeRect(getsc().x, getsc().y, getx() - getsc().x, gety() - getsc().y);
  this.context.closePath();
};
